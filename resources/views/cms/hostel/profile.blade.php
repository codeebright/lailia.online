                    ...
                    <div class="m-portlet__body">
                        <div class="m-card-profile">
                            ...
                            <div class="m-card-profile__details">
                                <span class="m-card-profile__name">حمید</span>
                                <a href="" class="m-card-profile__email m-link">hamidullah.hamid@gmail.com</a>
                            </div>
                        </div>
                        <ul class="m-nav m-nav--hover-bg m-portlet-fit--sides">
                                    ...
                                    <i class="m-nav__link-icon flaticon-profile-1"></i>
													<span class="m-nav__link-title">
														<span class="m-nav__link-wrap">
															...
															<span class="m-nav__link-badge"><span class="m-badge m-badge--success">۲</span></span>
														</span>
													</span>
                                </a>
                            </li>
                            ...
                            <li class="m-nav__item">
                                <a href="header/profile&amp;demo=default.html" class="m-nav__link">
                                    ...
                                    <span class="m-nav__link-text">فروشات</span>
                                </a>
                            </li>
                            {{--<li class="m-nav__item">--}}
                            {{--<a href="header/profile&amp;demo=default.html" class="m-nav__link">--}}
                            {{--<i class="m-nav__link-icon flaticon-time-3"></i>--}}
                            {{--<span class="m-nav__link-text">حادثه ها</span>--}}
                            {{--</a>--}}
                            {{--</li>--}}
                            {{--<li class="m-nav__item">--}}
                            {{--<a href="header/profile&amp;demo=default.html" class="m-nav__link">--}}
                            {{--<i class="m-nav__link-icon flaticon-lifebuoy"></i>--}}
                            {{--<span class="m-nav__link-text">همایت</span>--}}
                            {{--</a>--}}
                            {{--</li>--}}
                        </ul>
                        ...
                        {{--<div class="m-widget1 m-widget1--paddingless">
                            <div class="m-widget1__item">
                                <div class="row m-row--no-padding align-items-center">
                                    <div class="col">
                                        <h3 class="m-widget1__title">درآمد اعضای</h3>
                                        <span class="m-widget1__desc">درامد هفته وار</span>
                                    </div>
                                    <div class="col m--align-right">
                                        <span class="m-widget1__number m--font-brand">+$۱۷۰۰</span>
                                    </div>
                                </div>
                            </div>
                            <div class="m-widget1__item">
                                <div class="row m-row--no-padding align-items-center">
                                    <div class="col">
                                        <h3 class="m-widget1__title">فرمایشات</h3>
                                        <span class="m-widget1__desc">فرمایشات روازنه مشتری</span>
                                    </div>
                                    <div class="col m--align-right">
                            ...
                            <div class="m-widget1__item">
                                <div class="row m-row--no-padding align-items-center">
                                    <div class="col">
                                        <h3 class="m-widget1__title">گزارشات</h3>
                            ...
                            <form class="m-form m-form--fit m-form--label-align-right">
                                <div class="m-portlet__body">
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-7">
                                            <input class="form-control m-input" type="text" value="حمیدالله حمید">
                                        </div>
                                    </div>
                                    <div class="form-group m-form__group row">
                                        <label for="example-text-input" class="col-2 col-form-label">ایمیل ادرس</label>
                                        <div class="col-7">
                                            <input class="form-control m-input" type="email" value="hamidullah.hamid@gmail.com">
                                        </div>
                                    </div>{{--
                                    <div class="form-group m-form__group row">
                                        <label for="example-text-input" class="col-2 col-form-label">نام لیلیه</label>
                                        <div class="col-7">
                                            <input class="form-control m-input" type="text" value="بانوان">
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-7">
                                            <input class="form-control m-input" type="text" value="+۹۳۷۳۰۳۱۳۱۰۱">
                                        </div>
                                    </div>
                                    {{--    <div class="m-form__seperator m-form__seperator--dashed m-form__seperator--space-2x"></div>
                                        <div class="form-group m-form__group row">
                                            <div class="col-10 ml-auto">
                                                <h3 class="m-form__section">2. </h3>
                                            </div>
                                        </div>
                                        <div class="form-group m-form__group row">
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-7">
                                            <input class="form-control m-input" type="text" value="www.linkedin.com/hamidullah">
                                        </div>
                                    </div>
                                    <div class="form-group m-form__group row">
                                        <label for="example-text-input" class="col-2 col-form-label">Facebook</label>
                                        <div class="col-7">
                                            <input class="form-control m-input" type="text" value="www.facebook.com/hamidlullah">
                                        </div>
                                    </div>
                                    <div class="form-group m-form__group row">
                                        <label for="example-text-input" class="col-2 col-form-label">Twitter</label>
                                        <div class="col-7">
                                            <input class="form-control m-input" type="text" value="www.twitter.com/hamidullah">
                                        </div>
                                    </div>
                                    <div class="form-group m-form__group row">
                                        <label for="example-text-input" class="col-2 col-form-label">Instagram</label>
                                        <div class="col-7">
                                            <input class="form-control m-input" type="text" value="www.instagram.com/hamidullah">
                                        </div>
                                    </div>
                                </div>
                                <div class="m-portlet__foot m-portlet__foot--fit">
                                    <div class="m-form__actions">
                                        <div class="row">
                                            ...
                                            <div class="col-7">
                                                <button type="reset" class="btn btn-accent m-btn m-btn--air m-btn--custom">ذخیره تغیرات</button>&nbsp;&nbsp;
