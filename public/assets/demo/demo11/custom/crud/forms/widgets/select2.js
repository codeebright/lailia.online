var Select2 = {
    init: function () {
        ...
        }), $("#m_select2_12_1, #m_select2_12_2, #m_select2_12_3, #m_select2_12_4, #m_select2_12_5, #m_select2_12_6,#m_select2_12_7, #m_select2_12_8, #m_select2_12_9, #m_select2_12_10").select2({placeholder: "Select an option"}), $("#m_select2_7").select2({placeholder: "Select an option"}), $("#m_select2_8").select2({placeholder: "Select an option"}), $("#m_select2_9").select2({
